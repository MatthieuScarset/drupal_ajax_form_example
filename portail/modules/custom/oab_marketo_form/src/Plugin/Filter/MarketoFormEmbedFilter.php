...
namespace Drupal\oab_marketo_form\Plugin\Filter;
 ...
 *
 * @Filter(
 *   id = "marketo_form_embed",
 *   title = @Translation("Display embedded Marketo form"),
 ...
 * )
 */
class MarketoFormEmbedFilter extends FilterBase implements ContainerFactoryPluginInterface {
