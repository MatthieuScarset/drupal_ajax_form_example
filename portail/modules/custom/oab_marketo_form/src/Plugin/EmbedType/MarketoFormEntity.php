...
namespace Drupal\oab_marketo_form\Plugin\EmbedType;
 ...
 * )
 */
class MarketoFormEntity extends EmbedTypeBase implements ContainerFactoryPluginInterface {
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setValue('entity_type', 'marketo_form');
