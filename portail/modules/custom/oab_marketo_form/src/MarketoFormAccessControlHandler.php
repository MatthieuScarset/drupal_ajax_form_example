...
/**
 * Access controller for the Marketo Form entity.
 *
 * @see \Drupal\oab_marketo_form\Entity\MarketoForm
 */
class MarketoFormAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'create marketo form');
  }
