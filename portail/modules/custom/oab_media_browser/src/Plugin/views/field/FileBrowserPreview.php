...
/**
 * @file
 * Contains \Drupal\oab_media_browser\Plugin\views\field\FileBrowserPreview.
 */

namespace Drupal\oab_media_browser\Plugin\views\field;
 ...
 *
 * @ViewsField("oab_media_browser_preview")
 */
class FileBrowserPreview extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    // @todo See if we can use fallback formatters for this.
      ...
      $path = drupal_get_path('module', 'oab_media_browser');
      $build = [
        '#theme' => 'image',
        '#attributes' => array(
