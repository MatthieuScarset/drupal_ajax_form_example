CKEDITOR.editorConfig = function(config) {
    CKEDITOR.config.extraPlugins = 'layoutmanager, fontawesome, templating, embed, embedbase, notificationaggregator, notification, toolbar, button, solaris, panel, panelbutton, colorbutton';
