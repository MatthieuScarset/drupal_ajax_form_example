...
function chargement_engine() {
	...
	if ( ChargementNecessaire && Cpt_Chargement <= 3) {
		...
		if ( ! Script_Data ) {
			...
			var src = RessourcesPath+"suggest_data.js.php?mid=5cefd4762f0955cadc342c5f122d8a36";
		...
		if ( ! Script_CSS  && Cpt_Chargement <= 1 ) {
			...
			Elt.type = "text/css";
			Elt.rel="stylesheet";
			Elt.href = RessourcesPath+"suggest.css.php?mid=5cefd4762f0955cadc342c5f122d8a36"+supp;
			Head.appendChild(Elt);
			Script_CSS = true;
		}
