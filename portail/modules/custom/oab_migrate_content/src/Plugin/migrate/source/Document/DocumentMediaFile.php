 ...
 *
 * @MigrateSource(
 *   id = "document_media_file"
 * )
 */
class DocumentMediaFile extends SqlBase {
  ...
  public function prepareRow(Row $row) {
    ...
    $file_query = $this->select('field_data_field_file_upl', 'fi');
    $file_query->fields('fi', ['field_file_upl_description'])
    ->condition('fi.field_file_upl_fid', $row->getSourceProperty('fid'), '=')
