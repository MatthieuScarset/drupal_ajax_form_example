    ...
    for(var i=0, len=visible_followbar_buttons.length;i<len;i++){
        ...
        if(currentSVGIcon != null && currentFollowPage != null && currentSVGIcon != "" && currentFollowPage != ""){
        	if(currentButton == "newsletter"){
        		...
        		if(followbar_parameters.locale == "ar_AR"){
        			followbarHTML += "<a href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', '" + window.location.pathname + "', 7300);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + currentButton + " " + staticTextLocale.accessibility.follow + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        		}else{
        			followbarHTML += "<a href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', '" + window.location.pathname + "', 7300);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.follow + " " + currentButton + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        		}
        	}
        }
    }
