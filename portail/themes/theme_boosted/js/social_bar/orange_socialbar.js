        ...
        if(visible_sharebar_buttons[i].button === 'email'){
            if(visible_sharebar_buttons[i].mailto === false){
                if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
	        		if(sharebar_parameters.og_locale == "ar_AR"){
	        			sharebarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"mailto:?subject=" + sharebar_parameters.email_subject + "&cc=&bcc=&body=" + sharebar_parameters.email_message + "\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">email " + staticTextLocale.accessibility.sharewith + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.email + "</svg></a>";
	        		}else{
	        			sharebarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"mailto:?subject=" + sharebar_parameters.email_subject + "&cc=&bcc=&body=" + sharebar_parameters.email_message + "\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.sharewith + " email</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.email + "</svg></a>";
	        		}
                }else{
	        		if(sharebar_parameters.og_locale == "ar_AR"){
                    sharebarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">email " + staticTextLocale.accessibility.sharewith + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.email + "</svg></a>";
	        		}else{
	        ...
	        if(getDeviceAndVersion().os == "iOS" && getDeviceAndVersion().version != 7){
	        	if(sharebar_parameters.og_locale == "ar_AR"){
					sharebarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">SMS " + staticTextLocale.accessibility.sharewith + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.sms + "</svg></a>";
	        	}else{
		            sharebarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.sharewith + " SMS</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + svgIcons.sms + "</svg></a>";
	        	}
	        }
        }else{
            ...
            if(sharebar_parameters.og_locale === "ar_AR"){
        		sharebarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);shareClick('" + currentButton + "');\" title=\"" + staticTextLocale.accessibility.shareon + " " + currentButton + "\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + currentButton + " " + staticTextLocale.accessibility.shareon + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}else{
            	sharebarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);shareClick('" + currentButton + "');\" title=\"" + staticTextLocale.accessibility.shareon + " " + currentButton + "\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.shareon + " " + currentButton + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}
        }
    }
    sharebarHTML += "</div>";
    ...
    for(var i=0, len=visible_followbar_buttons.length;i<len;i++){
        ...
        if(currentSVGIcon != null && currentFollowPage != null && currentSVGIcon != "" && currentFollowPage != ""){
        	if(currentButton == "newsletter"){
				followbarHTML += "<a  onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', '" + window.location.pathname + "', 7300);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.newsletter + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}else{
        		if(followbar_parameters.locale == "ar_AR"){
        			followbarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', '" + window.location.pathname + "', 7300);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + currentButton + " " + staticTextLocale.accessibility.follow + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        		}else{
        			followbarHTML += "<a onmousedown=\"utag_link(utag_data.type_page, 'Barre de partage', 'Partager', '"+ currentButton +"');\" href=\"" + currentFollowPage + "\" target=\"_blank\" class=\"follow_" + currentButton + "\" onclick=\"setCookie('follow_" + currentButton + "', '" + window.location.pathname + "', 7300);\" id=\"follow_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.follow + " " + currentButton + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        		}
        	}
        }
    }
