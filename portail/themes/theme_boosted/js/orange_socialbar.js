...
var showShareBar = function(){
    ...
    for(var i=0, len=visible_sharebar_buttons.length;i<len;i++){
        ...
        if(visible_sharebar_buttons[i].button === 'email'){
            ...
            if(sharebar_parameters.og_locale === "ar_AR"){
        		sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + currentButton + " " + staticTextLocale.accessibility.shareon + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}else{
            	sharebarHTML += "<a href=\"javascript:void(0)\" onclick=\"setCookie('share_" + currentButton + "', '" + window.location.pathname + "', 7300);shareClick('" + currentButton + "');\" class=\"share_" + currentButton + "\" id=\"share_" + currentButton + "\"><span class=\"sr-only\">" + staticTextLocale.accessibility.shareon + " " + currentButton + "</span><svg version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" x=\"0px\" y=\"0px\" width=\"32px\" height=\"32px\" viewBox=\"0 0 32 32\" enable-background=\"new 0 0 32 32\" xml:space=\"preserve\">" + currentSVGIcon + "</svg></a>";
        	}
        }
    }
    sharebarHTML += "</div>";
