...
var solaris = '';
var icons = Array();
icons[0] = Array('icon-3g', '3G');
icons[1] = Array('icon-4g', '4G');
icons[2] = Array('icon-4g_cam', '4G Cam');
icons[3] = Array('icon-4G_Cam__Live_80', '4G Cam Live');
icons[4] = Array('icon-4G_Cam_Camera_80', '4G Cam Camera');
icons[5] = Array('icon-4G_Cam_Inbox80', '4G Cam Inbox');
icons[6] = Array('icon-4G_Cam_Outbox_80', '4G Cam outbox');
...
icons[30] = Array('icon-antenna', 'Antenna');
icons[31] = Array('icon-Apartment_building', 'Apartment Building');
icons[32] = Array('icon-assistance', 'Assistance');
icons[33] = Array('icon-Auditorium', 'Auditorium');
icons[34] = Array('icon-banking', 'Banking');
icons[35] = Array('icon-business_lounge', 'Business Lounge');
icons[36] = Array('icon-calendar_month', 'Calendar month');
icons[37] = Array('icon-call', 'Call');
icons[38] = Array('icon-checkbox_tick', 'Checkbox Tick');
icons[39] = Array('icon-cloud_backup', 'Cloud Backup');
icons[40] = Array('icon-Collective_class_training', 'Collective Class Training');
icons[41] = Array('icon-Comments', 'Comments');
icons[42] = Array('icon-device_desktop_computer', 'Device Desktop Computer');
icons[43] = Array('icon-device_laptop_computer', 'Device Laptop Computer');
icons[44] = Array('icon-device_smart_phone', 'Device Smart Phone');
icons[45] = Array('icon-device_tablet', 'Device Tablet');
icons[46] = Array('icon-mobile_network_coverage', 'Mobile Network Coverage');
icons[47] = Array('icon-networks', 'Networks');
icons[48] = Array('icon-NFC_tag', 'NFC tag');
icons[49] = Array('icon-orange_events', 'Orange Events');
icons[50] = Array('icon-wifi', 'Wifi');
