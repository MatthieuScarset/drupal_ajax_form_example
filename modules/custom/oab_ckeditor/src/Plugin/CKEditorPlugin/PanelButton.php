 ...
 * )
 */
class PanelButton extends PluginBase implements CKEditorPluginInterface, ContainerFactoryPluginInterface
{
  ...
  {
    $plugin = $this->pathResolver->getPath('module', 'oab_ckeditor') . '/js/plugins/panelbutton/plugin.js';
    return $plugin;
  }
  /**
