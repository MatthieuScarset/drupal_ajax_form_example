 ...
 * )
 */
class NotificationAggregator extends PluginBase implements CKEditorPluginInterface, ContainerFactoryPluginInterface
{
  ...
  {
    $plugin = $this->pathResolver->getPath('module', 'oab_ckeditor') . '/js/plugins/notificationaggregator/plugin.js';
    return $plugin;
  }
  /**
