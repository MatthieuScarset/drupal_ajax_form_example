 ...
 * @CKEditorPlugin(
 *   id = "embedbase",
 *   label = @Translation("CKEditor Embed base"),
 *   module = "ckeditor"
 * )
 */
class EmbedBase extends PluginBase implements CKEditorPluginInterface, ContainerFactoryPluginInterface
{
  ...
  {
    $plugin = $this->pathResolver->getPath('module', 'oab_ckeditor') . '/js/plugins/embedbase/plugin.js';
    return $plugin;
  }
  /**
