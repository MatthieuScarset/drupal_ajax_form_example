 ...
 * )
 */
class BaseWidget extends PluginBase implements CKEditorPluginInterface, ContainerFactoryPluginInterface
{
  ...
  {
    $plugin = $this->pathResolver->getPath('module', 'oab_ckeditor') . '/js/plugins/basewidget/plugin.js';
    return $plugin;
  }
  /**
