 ...
 * )
 */
class Richcombo extends PluginBase implements CKEditorPluginInterface, ContainerFactoryPluginInterface
{
  ...
  {
    $plugin = $this->pathResolver->getPath('module', 'oab_ckeditor') . '/js/plugins/richcombo/plugin.js';
    return $plugin;
  }
  /**
