...
class OabSettingsProductCategoriesDataImportForm extends FormBase {
  ...
  public static function create(ContainerInterface $container) {
    ...
    public function getFormId() {
        return 'oab_product_categories_data_import_form';
    }
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $form['import'] = array(
            '#type' => 'fieldset',
            '#title' => $this->t('Import Product/categories File'),
            '#weight' => 1,
            '#collapsible' => TRUE,
            '#collapsed' => TRUE,
        );
    ...
    public function validateImportHandler(array &$form, FormStateInterface $form_state) {
        ...
        if (!is_dir(ProductCategoriesDataImport::IMPORT_DIRECTORY)) {
            $fs->mkdir(ProductCategoriesDataImport::IMPORT_DIRECTORY, NULL, TRUE);
        }

        $file = file_save_upload('file', array('file_validate_extensions' => ''),
          ProductCategoriesDataImport::IMPORT_DIRECTORY, null,
