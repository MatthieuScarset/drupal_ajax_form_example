...
namespace Drupal\oab_media_browser\Form;
...
class EntityEmbedDialogOab extends EntityEmbedDialog {
    ...
    public function buildSelectStep(array $form, FormStateInterface $form_state) {
        ...
        if ($entity_type->entityClassImplements('\Drupal\Core\Entity\FieldableEntityInterface') && $entity_type->hasKey('label')) {
        ...
        $form['#title'] = $this->t('Select @type to embed', array('@type' => $entity_type->getSingularLabel()));
    ...
    public function buildReviewStep(array $form, FormStateInterface $form_state) {
        ...
        $form['#title'] = $this->t('Review selected @type', array('@type' => $entity->getEntityType()->getSingularLabel()));
    ...
    public function buildEmbedStep(array $form, FormStateInterface $form_state) {
        ...
        $form['#title'] = $this->t('Embed @type', array('@type' => $entity->getEntityType()->getSingularLabel()));
