...
class OabFrontofficBreadcrumbBuilder implements BreadcrumbBuilderInterface {
  ...
  public function build(RouteMatchInterface $route_match) {
    ...
    } elseif ($route_name === 'view.category_page.category_page'
      && isset($parameters['view_id']) && isset($parameters['display_id'])) {
      $breadcrumb->addLink(Link::fromTextAndUrl(t('Home'), $this->getHubFrontUrl()));
      $breadcrumb->addLink(Link::createFromRoute(t('Our solutions'), '<none>'));
    } else {
